    ...
    <>
      ...
      <header id="bg" className='w-5/6 rounded-3xl fixed z-20 top-3 left-1/2 -translate-x-2/4 py-2'>
          <div className='flex justify-between mx-2 lg:mx-14'> {/*Flex para organizar cabeçalho*/}
            <div className='min-[2200px]:w-[10%] md:hover:scale-125 transition duration-300'>
              <Link href='#home' activeClass="true" to="home" spy={true} smooth={true} offset={0} duration={600}><img src="/logo-ia.png" width={80} /></Link>
            </div>

            <nav id="nav" className='flex py-2 items-center'>
              <ul id='menu' className='flex justify-center items-center gap-10'>
                <li className='text-white text-lg 2xl:text-xl min-[2200px]:text-[32px] md:hover:scale-125 transition-all duration-300'><Link onClick={toggleMenu} href='#home' activeClass="true" to="home" spy={true} smooth={true} offset={0} duration={600}>Home</Link></li>
                <li className='text-white text-lg 2xl:text-xl min-[2200px]:text-[32px] md:hover:scale-125 transition-all duration-300'><Link onClick={toggleMenu} href='#sobre' activeClass="true" to="sobre" spy={true} smooth={true} offset={230} duration={600}>Sobre</Link></li>
                <li className='text-white text-lg 2xl:text-xl min-[2200px]:text-[32px] md:hover:scale-125 transition-all duration-300'><Link onClick={toggleMenu} href='#projetos' activeClass="true" to="projetos" spy={true} smooth={true} offset={0} duration={600}>Projetos</Link></li>
                <li className='text-white text-lg 2xl:text-xl min-[2200px]:text-[32px] md:hover:scale-125 transition-all duration-300'><Link onClick={toggleMenu} href='#habilidades' activeClass="true" to="habilidades" spy={true} smooth={true} offset={0} duration={600}>Habilidades</Link></li>
              </ul> 
      ...
      <section id="habilidades" className="bg-[url('../public/bg-skills.png')] bg-cover bg-right md:bg-center w-full bg-[#D1D7DD] py-14 overflow-hidden">
        <div className='w-full m-auto text-[#373c47] text-center mt-12'>
          <h2 data-aos="flip-up" className='text-5xl italic font-bold'>Habilidades</h2>
          <p data-aos="fade-right" className='text-xl mt-4'>Clique ou toque em uma habilidade para saber mais!</p>
        </div>
        ...
        <div className='w-full relative items-center flex flex-col mt-4 px-4 md:flex-row md:flex-wrap md:justify-around lg:w-5/6 m-auto'> {/* Inicio FLEX CARDS */} 
          ...
          <div data-aos="zoom-in-left" className='w-[270px] h-[270px] relative my-4 md:m-4'>
            <div onClick={flipCardnext} id="next" className='absolute w-[270px] h-[270px] style-3d transition-all duration-500 ease-linear'>{/* Cartão NEXT.JS */}
              ...
              {/* VERSO */}
              <div className='absolute w-[270px] h-[270px] bg-[#141f35] flex flex-col px-9 pt-16 pb-12 rounded-full text-center my-4 hover backface rotate'>
